           ...
           <div class="pt-3 my-3 text-center">
            ...
            <form action="/dashboard/posts/{{ $post->slug }}" method="post">
               ...
               <div class="mb-3">
                  ...
                  <input class="form-control @error('slug') is-invalid @enderror" type="text" name="slug" id="slug" value="{{ old('slug', $post->slug) }}" required>
                  @error('slug')
                     <div class="invalid-feedback">
                        {{ $message }}
                     </div>
               ...
               <div class="mb-3">
                  ...
                  <input type="hidden" class="@error('body') is-invalid @enderror" id="body" name="body" value="{{ old('body', $post->body) }}">
